...
class MainPageMobile{
    ...
    async checkPage() {
        console.log('проверка страницы Игровые телефоны');
            const lala = await this.driver.findElement(By.xpath('//*[@id="/content/page/fancyPage/cms/0/126457331-SearchTitleSimple"]/h1')).getText();
            return lala;
    }
    async logElements() {
